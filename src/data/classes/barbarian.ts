...
export const barbarian: Class = {
  ...
  hitPoints: {
    ...
    higherLevels: '7 + модификатор Телосложения за каждый уровень после первого'
  },
  proficiencies: {
